      ...
      child: Column(
        ...
        children: [
          ...
          Padding(
            ...
            child: Text(
              AppLocalizations.of(context).cameraOffSubtitle,
                      ...
                      children: [
                        ...
                        Text(
                          CurrencyFormatter.format(
                              state.totalAmount, Localizations.localeOf(context)),
                          style: TextStyle(
                              fontSize: 20,
    ...
    return Center(
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 16),
          Text(AppLocalizations.of(context).listEmptyTitle,
              style: const TextStyle(fontWeight: FontWeight.bold, fontSize: 18)),
          const SizedBox(height: 8),
          Padding(
            padding: const EdgeInsets.symmetric(horizontal: 40),
            child: Text(
              AppLocalizations.of(context).listEmptySubtitle,
              textAlign: TextAlign.center,
          ...
          Expanded(
            child: Column(
              ...
              children: [
                ...
                Text(
                  CurrencyFormatter.format(
                      item.product.price, Localizations.localeOf(context)),
                  style: TextStyle(
                      fontWeight: FontWeight.bold,
                      fontSize: 14,
