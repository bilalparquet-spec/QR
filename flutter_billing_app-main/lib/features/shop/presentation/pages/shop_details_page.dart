              ...
              child: Form(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    const SizedBox(height: 15),
                    InputLabel(text: l10n.addressLine2Label),
                    _buildTextField(
                    ...
                    const SizedBox(height: 15),
                    InputLabel(text: l10n.paymentReferenceLabel),
                    _buildTextField(
                      controller: _upiController,
                      hint: l10n.paymentReferenceHint,
                    ),
                    const SizedBox(height: 15),
                    Row(
                      mainAxisAlignment: MainAxisAlignment.spaceBetween,
                      children: [
                        InputLabel(text: l10n.footerTextLabel),
                        Text(l10n.maxChars(60),
                            style: TextStyle(
