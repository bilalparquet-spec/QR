...
3. Vercel will auto-detect `vercel.json` and run `vercel_build.sh`, which fetches Flutter, runs `flutter gen-l10n`, and builds to `build/web`. No extra configuration needed.
